...
public class UByte extends java.lang.Number
{
      ...
      public UByte(byte value) { mValue = Utils.unsigned_byte(value); }
      ...
      public synchronized void setValue(int theValue) { mValue = (Math.abs(theValue)) & 0xFF; }

      public String toHexString() { return Integer.toHexString(mValue); }
}
